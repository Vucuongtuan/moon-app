...
export function SearchModal() {
    ...
    return (
        <>
            <TouchableOpacity onPress={toggleModal} accessibilityRole="button" accessibilityLabel="Open search">
                ...
                <ThemedView style={{ flex: 1 }}>
                    <SafeAreaView style={{ flex: 1 }}>
                        <View style={[styles.headerCtn, isDark && styles.headerCtnDark]}>
                            <TouchableOpacity onPress={toggleModal} accessibilityRole="button" accessibilityLabel="Close search">
                            ...
                            {keyword.length > 0 && (
                                <TouchableOpacity onPress={() => setKeyword("")} accessibilityRole="button" accessibilityLabel="Clear search input">
